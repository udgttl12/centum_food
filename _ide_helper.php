...
')
     ...
     */ 
         ...
         * @param array $options
         * @return \Acaronlex\LaravelCalendar\SimpleEvent 
         * @static 
         */ 
        public static function event($title, $isAllDay, $start, $end, $id = null, $options = [])
        {
                        return \Acaronlex\LaravelCalendar\Calendar::event($title, $isAllDay, $start, $end, $id, $options);
        }
                    /**
        ...
        {
                        /** @var \Acaronlex\LaravelCalendar\Calendar $instance */
         ...
         *
         * @param string $id
         * @return \Acaronlex\LaravelCalendar\Calendar 
         * @static 
         */ 
        public static function setId($id)
        {
...
namespace  { 
            ...
            class Calendar extends \Acaronlex\LaravelCalendar\Facades\Calendar {}
